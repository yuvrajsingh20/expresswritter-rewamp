...
function AdminPayments() {
  ...
  const TRANSACTIONS = [
    { id: 'TXN-9812', client: 'Client #A204', service: 'SOP', amount: 144, currency: 'USD', gateway: 'Stripe', status: 'Paid', date: 'Apr 22, 2026', writerPayout: 101 },
    { id: 'TXN-9801', client: 'Client #B118', service: 'LinkedIn', amount: 75, currency: 'USD', gateway: 'Stripe', status: 'Paid', date: 'Apr 21, 2026', writerPayout: 52 },
    { id: 'TXN-9790', client: 'Client #C056', service: 'Research Proposal', amount: 280, currency: 'USD', gateway: 'Razorpay', status: 'Paid', date: 'Apr 20, 2026', writerPayout: 196 },
    { id: 'TXN-9783', client: 'Client #D302', service: 'Business Proposal', amount: 240, currency: 'USD', gateway: 'Stripe', status: 'Pending', date: 'Apr 22, 2026', writerPayout: 0 },
    { id: 'TXN-9771', client: 'Client #E741', service: 'Academic Essay', amount: 360, currency: 'USD', gateway: 'Stripe', status: 'Paid', date: 'Apr 18, 2026', writerPayout: 252 },
    { id: 'TXN-9760', client: 'Client #F209', service: 'Resume', amount: 90, currency: 'GBP', gateway: 'Razorpay', status: 'Refunded', date: 'Apr 17, 2026', writerPayout: 0 },
  ];

  const PAYOUTS = [
    { writer: 'Dr. Amara Singh', amount: 1980, currency: 'GBP', method: 'Bank Transfer', status: 'Scheduled', date: 'May 1, 2026', orders: 12 },
    { writer: 'James Whitfield', amount: 2340, currency: 'USD', method: 'PayPal', status: 'Scheduled', date: 'May 1, 2026', orders: 18 },
    { writer: 'Priya Nair', amount: 890, currency: 'INR', method: 'Razorpay', status: 'Processing', date: 'Apr 30, 2026', orders: 7 },
    { writer: 'Marcus Chen', amount: 3100, currency: 'USD', method: 'Wire Transfer', status: 'Paid', date: 'Apr 1, 2026', orders: 22 },
  ];
      ...
      {tab === 'Overview' && (
        <div style={{ animation: 'fadeIn .3s ease' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 14, marginBottom: 24 }}>
            {[
              { label: 'Total Revenue', val: '$26,840', sub: 'All time', color: 'var(--teal-light)' },
              { label: 'This Month', val: '$2,680', sub: 'Apr 2026', color: 'var(--green)' },
              { label: 'Pending Payouts', val: '$5,210', sub: '4 writers', color: 'var(--amber)' },
...
Object.assign(window, { AdminPayments, AdminCurrency });

...
function Input({ label, value, onChange, placeholder, type = 'text', mono, sublabel }) {
  return (
...
Object.assign(window, { Toggle, SectionHeader, Card, CardHeader, Pill, StatusDot, Btn, Input, Select, Table, SubTabs, SaveBar });

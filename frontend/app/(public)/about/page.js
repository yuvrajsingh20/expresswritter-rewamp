    ...
    <div className="landing-page-container">
      ...
      <div className="page-section">
        ...
        <div className="values-grid">
          ...
          <div className="value-card"><div className="value-icon" style={{background:'rgba(245,158,11,0.15)',color:'var(--amber)'}}>⚡</div><h3>On time, every time</h3><p>96% on-time rate. If we're late without prior agreement, you get a full refund — automatically.</p></div>
          ...
          <div className="value-card"><div className="value-icon" style={{background:'rgba(34,197,94,0.15)',color:'var(--green)'}}>✓</div><h3>Original or your money back</h3><p>Every draft scanned for plagiarism and AI. Under 10% similarity guaranteed.</p></div>
